...
#设置SummaryWriter的路径
# WRITER_PATH = "./logs/1x1/evaluation/heavy_low_model_heavy_low_test/" + TIMESTAMP
...
# 拼接文件路径
csv_file_path = os.path.join(csv_folder_path, "CTB_evaluation.csv")
...
if __name__ == "__main__":
    ...
    prs.add_argument(
        ...
        default="./nets/syc/1x1/Equal_entries_350_CT/equal_entries_350.rou.xml", # CT
    ...
    env = SumoEnvironment(
        ...
        net_file="./nets/syc/1x1/Equal_entries_350_CT/syc_4phases.net.xml",  # CT
        ...
        cfg_file = "./nets/syc/1x1/Equal_entries_350_CT/syc_4phases_equal_entries_350.sumocfg", # CT
