...
path_checkpoint = os.path.expanduser("/home/xiaowen/sumo-rl/experiments/models/1x1/4_phases/equal_entries_350/Bus_Car/Eq350_BC_100-0-100-0/21/ckpt_2025-08-21T18-11-47_5000_21.pth")
if not os.path.exists(path_checkpoint):
    raise FileNotFoundError(f"Checkpoint path not found: {path_checkpoint}")

# 构建带有时间戳的文件路径
csv_folder_path = "./test_csv/1x1/4_phases/equal_entries_350/Bus_Car/Eq350_BC_100-0-100-0/21/" + TIMESTAMP + "/"
# 确保文件夹存在，如果不存在则创建
