...
path_checkpoint = os.path.expanduser("/home/xiaowen/sumo-rl/experiments/models/1x1/4_phases/equal_entries_350/Bus_Car/Eq350_BC_100-0-100-0/81/2025-09-04T12-03-49/ckpt_2025-09-04T14-35-40_5000.pth")
# 构建带有时间戳的文件路径
csv_folder_path = "./test_csv/1x1/4_phases/equal_entries_350/Bus_Car/Eq350_BC_100-0-100-0/81/" + TIMESTAMP + "/"
...
if __name__ == "__main__":
    ...
    env = SumoEnvironment(
        ...
        reward_fn = "81-priority-pressure", ############################第五个要改的地方#####################################
        delta_time = 5,
        single_agent=False,
    )
