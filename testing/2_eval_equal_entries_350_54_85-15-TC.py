...
#设置SummaryWriter的路径
# WRITER_PATH = "~/sumo-rl/logs/1x1/evaluation/heavy_low_model_heavy_low_test/" + TIMESTAMP
...
path_checkpoint = os.path.expanduser("~/sumo-rl/experiments/models/1x1/4_phases/equal_entries_350/CT/54/85-15-Truck-Car/checkpoint/2025-06-25T11-58-44/ckpt_2025-06-25T13-22-17_2000.pth")
if not os.path.exists(path_checkpoint):
    raise FileNotFoundError(f"Checkpoint path not found: {path_checkpoint}")
checkpoint = torch.load(path_checkpoint)
# path_checkpoint = "./models/1x1/mixed_scenarios/checkpoint/2024-04-15T11-55-36-0.01/ckpt_2024-04-15T16-57-14_5000.pth" #mixed model
...
if __name__ == "__main__":
    ...
    prs.add_argument(
        ...
        default="~/sumo-rl/nets/syc/1x1/Equal_entries_350_CT/85-15-Truck-Car/equal_entries_350_54_85-15-TC.rou.xml", # CT
    ...
    env = SumoEnvironment(
        ...
        net_file="~/sumo-rl/nets/syc/1x1/Equal_entries_350_CT/85-15-Truck-Car/syc_4phases.net.xml",  # CT
        ...
        cfg_file = "~/sumo-rl/nets/syc/1x1/Equal_entries_350_CT/85-15-Truck-Car/syc_4phases_equal_entries_350_54_85-15-TC.sumocfg", # CT
