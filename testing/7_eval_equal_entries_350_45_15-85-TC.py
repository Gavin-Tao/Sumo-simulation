...
path_checkpoint = os.path.expanduser("~/sumo-rl/experiments/models/1x1/4_phases/equal_entries_350/CT/45/15-85-Truck-Car/checkpoint/2025-06-25T12-06-32/ckpt_2025-06-25T13-30-57_2000.pth")
...
if __name__ == "__main__":
    ...
    env = SumoEnvironment(
        ...
        reward_fn = "45-priority-pressure",
        delta_time = 5,
        single_agent=False,
    )
