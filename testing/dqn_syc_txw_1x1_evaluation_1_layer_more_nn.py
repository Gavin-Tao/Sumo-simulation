...
HIDDEN_NUMBER = 512
#设置SummaryWriter的路径
WRITER_PATH = f"./logs/1x1/evaluation/mixed_model_low_heavy_test/{HIDDEN_NUMBER}/" + TIMESTAMP
...
path_checkpoint = r"E:\txw\sumo-rl\models\1x1\mixed_scenarios\more_nn\checkpoint\2024-05-13T20-10-20-512\ckpt_2024-05-15T00-07-51_24000.pth" #mixed model


# 构建带有时间戳的文件路径
csv_folder_path = f"./testing/mixed_model_low_heavy_test/{HIDDEN_NUMBER}/" + TIMESTAMP + "/"
...
# 拼接文件路径
csv_file_path = os.path.join(csv_folder_path, "mixed_low_heavy_train_evaluation.csv")
