...
from sumo_rl.environment.observations import QueuePrioObservationFunction

from torch.utils.tensorboard import SummaryWriter
import math
TIMESTAMP = "{0:%Y-%m-%dT%H-%M-%S/}".format(datetime.now())
#设置SummaryWriter的路径
WRITER_PATH = "./logs/1x3/" + TIMESTAMP
...
if __name__ == "__main__":
    ...
    prs.add_argument(
        ...
        dest="route",
        type=str,
        default="../nets/syc/1x3/Eq_350_BC_Wstr_Estr-Wleft_Eleft/Eq_350_100-0-100-0-Bus-Car/Eq_350_100-0-100-0-Bus-Car.rou.xml",
    ...
    env = SumoEnvironment(
        net_file="../nets/syc/1x3/Eq_350_BC_Wstr_Estr-Wleft_Eleft/Eq_350_100-0-100-0-Bus-Car/1x3_4phases.net.xml",
        route_file=args.route,
        cfg_file = "../nets/syc/1x3/Eq_350_BC_Wstr_Estr-Wleft_Eleft/Eq_350_100-0-100-0-Bus-Car/Eq_350_100-0-100-0-Bus-Car.sumocfg",
        ...
        observation_class = QueuePrioObservationFunction,
        reward_fn = "21-priority-queue",
        delta_time = 5,
        single_agent=False,
    )
