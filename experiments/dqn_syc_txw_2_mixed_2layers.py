...
WRITE_TB = False
HIDDEN_NUMBER = 512
WRITER_PATH = f"./logs/1x1/4_phases/mixed_scenarios/two_layer/{HIDDEN_NUMBER}/" + TIMESTAMP
STORE_PATH = f"./models/1x1/mixed_scenarios/checkpoint/two_layer/{HIDDEN_NUMBER}/"+ TIMESTAMP
