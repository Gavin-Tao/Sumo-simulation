...
############################ -1----修改路径----------------------#############################
WRITER_PATH = "./logs/1x1/4_phases/equal_entries_350/Presslight/" + TIMESTAMP
STORE_PATH  = "./models/1x1/4_phases/equal_entries_350/Presslight/checkpoint/" + TIMESTAMP
...
if __name__ == "__main__":
    ...
    env = SumoEnvironment(
        ...
        observation_class = PressLightObservationFunction, ############################ -6----修改observation----------------------#############################
        reward_fn = "pressure",   ############################ --7---修改reward函数----------------------#############################
        delta_time = 5,
    )
