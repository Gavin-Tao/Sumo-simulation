...
from sumo_rl.agents.dqn_agent_txw_3layers import DQN3
...
HIDDEN_NUMBER = 512
WRITE_TB = False
WRITER_PATH = f"./logs/1x1/4_phases/mixed_scenarios/three_layer/{HIDDEN_NUMBER}/" + TIMESTAMP
STORE_PATH = f"./models/1x1/mixed_scenarios/checkpoint/three_layer/{HIDDEN_NUMBER}/"+ TIMESTAMP
