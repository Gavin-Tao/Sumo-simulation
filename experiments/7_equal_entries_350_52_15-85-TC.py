...
############################ -1----修改路径----------------------#############################
WRITER_PATH = "./logs/1x1/4_phases/equal_entries_350/CT/45/15-85-Truck-Car/" + TIMESTAMP
STORE_PATH  = "./models/1x1/4_phases/equal_entries_350/CT/45/15-85-Truck-Car/checkpoint/" + TIMESTAMP
...
if __name__ == "__main__":
    ...
    env = SumoEnvironment(                                            ### -3---优先级变化的时候不影响rou文件这些，所以还用的54的文件--###########
        ...
        reward_fn = "45-priority-pressure", ############################ --7---修改reward函数----------------------#############################
        delta_time = 5,
    )
