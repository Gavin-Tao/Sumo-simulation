...
CFGS = {"217": "configs/exp217_1x1_531_NS20bus_vanilla_B_movement_legacy_cqm.yaml",
        ...
        "227a": "configs/exp227a_1x1_finetune421_obsfix.yaml"}
...
if variant == "blind":
    obs_kwargs["priority_source"] = ({"ambulance": 1, "bus": 4, "truck": 2, "car": 1} if which == "227a" else ({"ambulance": 1, "bus": 3, "car": 1} if "priority_source" in cfg else {"ambulance": 1, "bus": 4, "truck": 2, "car": 1}))
elif which == "227a":
    obs_kwargs["priority_source"] = cfg["obs_priority_source"]
elif variant == "w421b":
