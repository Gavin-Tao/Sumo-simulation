...
#设置SummaryWriter的路径
WRITER_PATH = "./logs/1x1/4_phases/equal_entries_140/" + TIMESTAMP
STORE_PATH = "./models/1x1/equal_entries_140/checkpoint/"+ TIMESTAMP
...
if __name__ == "__main__":
    ...
    prs.add_argument(
        ...
        dest="route",
        type=str,
        default="nets/syc/1x1/Equal_entries_140/equal_entries_140.rou.xml",
    ...
    env = SumoEnvironment(
        net_file="nets/syc/1x1/Equal_entries_140/syc_4phases.net.xml",
        route_file=args.route,
        cfg_file = "nets/syc/1x1/Equal_entries_140/syc_4phases_equal_entries_140.sumocfg",
