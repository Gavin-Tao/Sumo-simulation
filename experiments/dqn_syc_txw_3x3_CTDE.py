...
#设置SummaryWriter的路径
WRITER_PATH = "./logs/3x3/" + TIMESTAMP
...
if __name__ == "__main__":
    ...
    prs.add_argument(
        ...
        dest="route",
        type=str,
        default="nets/syc/3x3/intersection_heavy_new.rou.xml",
    ...
    env = SumoEnvironment(
        net_file="nets/syc/3x3/intersection_new.net.xml",
        route_file=args.route,
        cfg_file = "nets/syc/3x3/syc_new.sumocfg",
        ...
        for episode in range(1, episodes + 1):
            ...
            if dqn_agent.start_train:
                if episode != 0 and episode % checkpoint_interval == 0:
                    ...
                    if os.path.exists("./models/3x3/checkpoint") is False:
                        os.makedirs("./models/3x3/checkpoint")
                    ckpt_timestamp = "{0:%Y-%m-%dT%H-%M-%S}".format(datetime.now())
                    path_checkpoint = "./models/3x3/checkpoint/ckpt_{0}_{1}.pth".format(ckpt_timestamp, episode)
