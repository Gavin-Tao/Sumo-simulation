...
#设置SummaryWriter的路径
WRITER_PATH = "./logs/1x1/4_phases/equal_entries_500/" + TIMESTAMP
STORE_PATH = "./models/1x1/equal_entries_500/checkpoint/"+ TIMESTAMP
...
if __name__ == "__main__":
    ...
    prs.add_argument(
        ...
        dest="route",
        type=str,
        default="nets/syc/1x1/Equal_entries_500/equal_entries_500.rou.xml",
