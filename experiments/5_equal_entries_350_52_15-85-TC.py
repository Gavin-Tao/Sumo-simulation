...
############################ -1----修改路径----------------------#############################
WRITER_PATH = "./logs/1x1/4_phases/equal_entries_350/CT/52/15-85-Truck-Car/" + TIMESTAMP
STORE_PATH  = "./models/1x1/4_phases/equal_entries_350/CT/52/15-85-Truck-Car/checkpoint/" + TIMESTAMP
...
if __name__ == "__main__":
    ...
    prs.add_argument(
        "-route",
        dest="route",
        type=str,                                                       ### -3---优先级变化的时候不影响rou文件这些，所以还用的54的文件--###########
        default="./nets/syc/1x1/Equal_entries_350_CT/15-85-Truck-Car/equal_entries_350_54_15-85-TC.rou.xml", ############################ -3----修改rou文件的路径----------------------#############################
    ...
    env = SumoEnvironment(                                            ### -3---优先级变化的时候不影响rou文件这些，所以还用的54的文件--###########
        net_file="./nets/syc/1x1/Equal_entries_350_CT/15-85-Truck-Car/syc_4phases.net.xml", ############################ -4----修改net文件的路径----------------------#############################
        route_file=args.route,                                        ### -3---优先级变化的时候不影响rou文件这些，所以还用的54的文件--###########
        cfg_file = "./nets/syc/1x1/Equal_entries_350_CT/15-85-Truck-Car/syc_4phases_equal_entries_350_54_15-85-TC.sumocfg", ############################ -5----修改cfg文件的路径----------------------#############################
        ...
        reward_fn = "52-priority-pressure", ############################ --7---修改reward函数----------------------#############################
        delta_time = 5,
    )
