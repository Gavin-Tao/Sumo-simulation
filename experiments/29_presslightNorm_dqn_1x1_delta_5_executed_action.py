...
from sumo_rl.environment.observations import PressLightNormObservationFunction
...
if __name__ == "__main__":
    ...
    wandb.init(project="sumo-rl-1x1", name=f"5min_29_py_pressNorm_delta5_{experiment_time}")
    ...
    env = SumoEnvironment(
        ...
        observation_class = PressLightNormObservationFunction,
        reward_fn = "pressure-norm",
        delta_time = 5,
        single_agent=False,
    )
