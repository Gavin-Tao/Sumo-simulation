...
############################ -1----修改路径----------------------#############################
WRITER_PATH = "./logs/1x1/4_phases/equal_entries_500/Presslight/" + TIMESTAMP
STORE_PATH  = "./models/1x1/4_phases/equal_entries_500/Presslight/checkpoint/" + TIMESTAMP
...
if __name__ == "__main__":
    ...
    prs.add_argument(
        ...
        dest="route",
        type=str,
        default="./nets/syc/1x1/Equal_entries_500_CT/equal_entries_500_54_15-85-TC.rou.xml", ############################ -3----修改rou文件的路径----------------------#############################
    ...
    env = SumoEnvironment(
        net_file="./nets/syc/1x1/Equal_entries_500_CT/syc_4phases.net.xml", ############################ -4----修改net文件的路径----------------------#############################
        route_file=args.route,
        cfg_file = "./nets/syc/1x1/Equal_entries_500_CT/syc_4phases_equal_entries_500_54_15-85-TC.sumocfg", ############################ -5----修改cfg文件的路径----------------------#############################
