...
if __name__ == "__main__":
    ...
    prs.add_argument("-mingreen", dest="min_green", type=int, default=2, required=False, help="Minimum green time.\n")
    ...
    wandb.init(project="sumo-rl-1x1", name=f"2min_24_py_presslight_delta5_{experiment_time}")
