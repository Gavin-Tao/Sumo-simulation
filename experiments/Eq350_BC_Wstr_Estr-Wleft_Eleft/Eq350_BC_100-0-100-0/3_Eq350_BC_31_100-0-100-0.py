...
############################ -1----修改路径----------------------#############################
WRITER_PATH = "/home/xiaowen/sumo-rl/experiments/logs/1x1/4_phases/equal_entries_350/Bus_Car/Eq350_BC_100-0-100-0/31/" + TIMESTAMP
STORE_PATH  = "/home/xiaowen/sumo-rl/experiments/models/1x1/4_phases/equal_entries_350/Bus_Car/Eq350_BC_100-0-100-0/31/" + TIMESTAMP
...
if __name__ == "__main__":
    ...
    env = SumoEnvironment(
        ...
        reward_fn = "31-priority-pressure",   ############################ --7---修改reward函数----------------------#############################
        delta_time = 5,
    )
