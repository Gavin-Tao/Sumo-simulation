...
#设置SummaryWriter的路径
WRITER_PATH = "./logs/1x1/4phases/actuated/" + TIMESTAMP
...
if __name__ == "__main__":
    ...
    env = SumoEnvironment(
        ...
        net_file="nets/syc/1x1/syc_4phases_actuated.net.xml",
        route_file="nets/syc/1x1/syc.rou.xml",
        cfg_file = "nets/syc/1x1/syc_4phases_actuated.sumocfg",
