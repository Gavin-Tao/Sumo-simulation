...
############################ -1----修改路径----------------------#############################
WRITER_PATH = "./logs/1x1/4_phases/equal_entries_140/CT/54/15-85-Truck-Car/" + TIMESTAMP
STORE_PATH  = "./models/1x1/4_phases/equal_entries_140/CT/54/15-85-Truck-Car/checkpoint/" + TIMESTAMP
...
if __name__ == "__main__":
    ...
    env = SumoEnvironment(
        ...
        cfg_file = "./nets/syc/1x1/Equal_entries_140_CT/syc_4phases_equal_entries_140_54_15-85-TC.sumocfg", ############################ -5----修改cfg文件的路径----------------------#############################
